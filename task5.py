...
students_a = int(input('введите количество студентов a: '))
students_b = int(input('введите количество студентов b: '))
students_c = int(input('введите количество студентов c: '))
if students_a % 2 == 0:
        print(students_a//2)
elif students_a % 2 == 1:
        print(students_a//2 + 1)
if students_b % 2 == 0:
        print(students_b//2)
elif students_b % 2 == 1:
        print(students_b//2 + 1)
if students_c % 2 == 0:
        print(students_c//2)
elif students_c % 2 == 1:
        print(students_c//2 + 1)
